...
<style scoped>
.multi-range-slider {
  --bar-color: var(--theme-color-1);
  --bar-inner-color: var(--theme-active-color);

  --thumb-color: var(--theme-color-3);
  --thumb-caption-background-color: var(--theme-active-color);
  --thumb-caption-font-color: var(--default-font-color);
  --thumb-focus-color: var(--theme-active-color);

  --ruler-color: var(--theme-color-test-3);
  --label-color: var(--default-font-color);
}
...
.multi-range-slider .input-type-range:focus + .thumb::after {
  ...
  z-index: 2;
  border-radius: 50%;
  outline: 5px solid var(--thumb-focus-color);
...
.multi-range-slider .thumb .caption * {
  ...
  text-align: center;
  line-height: 30px;
  background-color: var(--thumb-caption-background-color);
  border-radius: 15px;
  color: var(--thumb-caption-font-color);
  padding: 0px 5px;
  white-space: nowrap;
}
