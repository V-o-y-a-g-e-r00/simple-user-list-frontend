  ...
  <div class="user-entry" :class="{ selected: isSelected }">
    <div class="avatar-holder">
      <img
        ...
        :src="getURL(user.profile_image_uri)"
      />
      <svg
        v-else
        width="84"
      ...
      >
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M54.6005 33.6C54.6005 40.5588 48.9593 46.2 42.0005 46.2C35.0417 46.2 29.4005 40.5588 29.4005 33.6C29.4005 26.6412 35.0417 21 42.0005 21C48.9593 21 54.6005 26.6412 54.6005 33.6ZM50.4005 33.6C50.4005 38.2392 46.6397 42 42.0005 42C37.3613 42 33.6005 38.2392 33.6005 33.6C33.6005 28.9608 37.3613 25.2 42.0005 25.2C46.6397 25.2 50.4005 28.9608 50.4005 33.6Z"
          fill="var(--theme-color-3)"
        />
        <path
          d="M42.0005 52.5C28.4043 52.5 16.82 60.5397 12.4072 71.8033C13.4822 72.8708 14.6146 73.8804 15.7994 74.8273C19.0854 64.4862 29.3936 56.7 42.0005 56.7C54.6074 56.7 64.9157 64.4862 68.2016 74.8274C69.3864 73.8805 70.5188 72.8708 71.5938 71.8033C67.1811 60.5397 55.5967 52.5 42.0005 52.5Z"
          fill="var(--theme-color-3)"
        />
      </svg>
    </div>
